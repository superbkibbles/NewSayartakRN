  ...
  return (
    <Button
      ...
      style={{
        ...
        overflow: 'hidden',
        height: calcHeight(params.image ? 91 : 80),
    ...
    >
      {params.image_url ? (
        ...
        <Icons
          style={{ paddingHorizontal: calcWidth(10) }}
          name={'notification'}
      ...
      <View style={{ alignItems: 'flex-start' }}>
        <Text_
          fontSize={'14'}
          style={{ marginTop: calcHeight(10), width: calcWidth(200) }}
          textAlign={'left'}
          fontFamily={'bold'}
        >
          {params.title}
        ...
        <Text_
          textAlign={'left'}
          fontSize={'12'}
          style={{ marginTop: calcHeight(5), width: calcWidth(235) }}
          color={config.colors.BLUE}
          fontFamily={'medium'}
        >
          {data.name ? data.name : params.data}
        </Text_>
        <TextWithIcon
          fontFamily={'bold'}
          textColor={config.colors.GRAY}
          fontSize={'11'}
          text={moment(params.created_at).fromNow()}
          iconName={'clock'}
          iconStyle={{ width: RFValue(12, 812), height: RFValue(12, 812) }}
        />
      </View>
    </Button>
  );
...
export function LoadingNotificationItem(params) {
  ...
  return (
    <View
      ...
      style={[{ marginTop: calcHeight(5) }, params.style]}
    >
      {length.map(() => {
        return (
          <View
