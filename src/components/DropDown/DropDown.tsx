...
export function DropDown(params: TabButtonsProps) {
  ...
  useEffect(() => {
    Animated.timing(rotate, {
      toValue: (
        typeof params.isActive !== 'undefined' ? params.isActive : isOpen
      )
        ? 1
        : 0,
  ...
  let rotate_ = rotate.interpolate({
    inputRange: [0, 1],
    outputRange: ['-90deg', '90deg'],
  });
  let height = rotate.interpolate({
    inputRange: [0, 1],
    outputRange: [calcHeight(45), params.height],
  });
  return (
    <Animated.View
      style={{
